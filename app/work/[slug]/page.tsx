...
const workItems = [
  ...
  { slug: 'aer-kollektiv-berlin',            common: 'AER Kollektiv Berlin',             photo: { url: '/cards/AER Kollektiv Berlin.jpg',                   pos: 'center' }, videos: [{ platform: 'youtube', id: 'UtPpVeWkAl8', vertical: true }, { platform: 'youtube', id: 'LQap28NX6oM', vertical: true }] as VideoEntry[], hideGrid: true },
];
